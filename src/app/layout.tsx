...
export const metadata: Metadata = {
  title: "Sakura Sushi - Authentic Japanese Sushi Restaurant",
  description: "Experience authentic Japanese sushi crafted by master chefs trained in Tokyo. Fresh ingredients, traditional techniques, and exceptional dining experience.",
  keywords: "sushi restaurant, Japanese cuisine, authentic sushi, fresh sashimi, Tokyo trained chefs, omakase, traditional Japanese dining",
  ...
  openGraph: {
    ...
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/tmp/uploaded-1763032688877-qb5a8z7s.jpg",
      alt: "Master sushi chef preparing fresh sushi at Sakura Sushi"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Sakura Sushi - Authentic Japanese Sushi Restaurant",
    description: "Experience authentic Japanese sushi crafted by master chefs trained in Tokyo. Fresh ingredients, traditional techniques, and exceptional dining experience.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/tmp/uploaded-1763032688877-qb5a8z7s.jpg"]
  },
  robots: {
    index: true,
    follow: true
